...
BOOST_AUTO_TEST_SUITE( Chapter_3_insertion_sort_v2 )

BOOST_AUTO_TEST_CASE( insertion_sort_random_vector )
{
    // IO
    const size_t iSz = 5;
    ...
    // sort
    BOOST_TEST_MESSAGE( cphb::insertion_sort_v2(iv) );
...
BOOST_AUTO_TEST_CASE( insertion_sort_sorted_vector )
{
    // IO
    const size_t iSz = 5;
    std::vector<int> iv(iSz), ov(iSz);
...
BOOST_AUTO_TEST_CASE( insertion_sort_reverse_sorted_vector )
{
    // IO
    const size_t iSz = 5;
    std::vector<int> iv(iSz), ov(iSz);
...
BOOST_AUTO_TEST_CASE( insertion_sort_all_n_vector )
{
    // IO
    const size_t iSz = 5;
    std::vector<int> iv(iSz), ov(iSz);
