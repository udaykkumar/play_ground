...
BOOST_AUTO_TEST_SUITE( Chapter_3_bubble_sort_v1 )

BOOST_AUTO_TEST_CASE( bubble_sort_random_vector )
{
    // IO
    const size_t iSz = 5;
...
BOOST_AUTO_TEST_CASE( bubble_sort_sorted_vector )
{
    // IO
    const size_t iSz = 5;
    std::vector<int> iv(iSz), ov(iSz);
...
BOOST_AUTO_TEST_CASE( bubble_sort_reverse_sorted_vector )
{
    // IO
    const size_t iSz = 5;
    std::vector<int> iv(iSz), ov(iSz);
...
BOOST_AUTO_TEST_CASE( bubble_sort_all_n_vector )
{
    // IO
    const size_t iSz = 5;
    std::vector<int> iv(iSz), ov(iSz);
