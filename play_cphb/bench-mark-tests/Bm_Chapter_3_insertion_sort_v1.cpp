...
static void Bm_Chapter_1_insertion_sort_v1_random(benchmark::State &state)
{
	// Perform setup here
	for (auto _ : state)
	{
		...
		cphb::insertion_sort_v1(iv);
	}
}
// Register the function as a benchmark
BENCHMARK(Bm_Chapter_1_insertion_sort_v1_random)->Range(8, 8 << 10);
