...
int main()
{
    ...
    std::cout << "intTuple 1st Element " << std::get<0>( multuTuple ) <<  std::endl;
    std::cout << "intTuple 2nd Element " << std::get<1>( multuTuple ) <<  std::endl;
    std::cout << "intTuple 3rd Element " << std::get<2>( multuTuple ) <<  std::endl;
    std::cout << "intTuple 4th Element " << std::get<3>( multuTuple ) <<  std::endl;
    std::cout << "intTuple 5th Element " << std::get<4>( multuTuple ) <<  std::endl;
    return 0;
}
