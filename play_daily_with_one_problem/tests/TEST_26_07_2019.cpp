...
BOOST_AUTO_TEST_CASE( Case_1 )
{
	std::string s1 = "b";
	std::string s2 = "a"; 
	BOOST_CHECK( daily_interview::distance( s1, s2, s1.length(), s2.length()) == 1 );
}
...
BOOST_AUTO_TEST_CASE( Case_3 )
{
	...
	BOOST_CHECK( daily_interview::distance( s1, s2, s1.length(), s2.length()) == 2 );
}
...
BOOST_AUTO_TEST_CASE( Case_4 )
{
	...
	BOOST_CHECK( daily_interview::distance( s1, s2, s1.length(), s2.length()) == 3 );
}
