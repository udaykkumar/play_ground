...
# configure time
#
# USAGE: git_clone( PROJECT_NAME                    <project name> GIT_URL <url>
# [GIT_TAG|GIT_BRANCH|GIT_COMMIT  <symbol>] [DIRECTORY <dir>] [QUIET] )
#
# ARGUMENTS: PROJECT_NAME name of the project that will be used in output
# variables. must be the same as the git directory/repo name
#
# GIT_URL url to the git repo
#
# GIT_TAG|GIT_BRANCH|GIT_COMMIT optional the tag/branch/commit to checkout
# default is master
#
# DIRECTORY optional the directory the project will be cloned into default is
# the build directory, similar to ExternalProject (${CMAKE_BINARY_DIR})
#
# QUIET optional don't print status messages
#
# OUTPUT VARIABLES: <project name>_SOURCE_DIR top level source directory of the
# cloned project
#
# EXAMPLE: git_clone( PROJECT_NAME    testProj GIT_URL
# https://github.com/test/test.git GIT_COMMIT      a1b2c3 DIRECTORY
...
function(git_clone)
  ...
  cmake_parse_arguments(
    ...
    "QUIET" # list of names of the boolean arguments (only defined ones will be
            # true)
    "PROJECT_NAME;GIT_URL;GIT_TAG;GIT_BRANCH;GIT_COMMIT;DIRECTORY" # list of
                                                                   # names of
                                                                   # mono-valued
                                                                   # arguments
