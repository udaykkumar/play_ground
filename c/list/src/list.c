...
DS_ErrorCodes_t DSList_addHead( DSList_t **listHead, const void * const data, const size_t dataSize )
{
...
DS_ErrorCodes_t DSList_addTail( DSList_t **listHead, const void * const data, const size_t dataSize )
{
    int retVal  = DS_INVALID;
...
DS_ErrorCodes_t DSList_DelHead( DSList_t **listHead, void * data, size_t *dataSize )
{
    int retVal  = DS_INVALID;
...
DS_ErrorCodes_t DSList_DelTail( DSList_t **listHead, void * data, size_t *dataSize )
{
    int retVal  = DS_INVALID;
